...
e2e_assert_contains "thread contains recipient" "${MAIL_THREAD_BODY}" "BlueBear"
...
e2e_assert_contains "thread strips script tag" "${MAIL_THREAD_BODY}" "alert(1)"
...
e2e_assert_contains "thread does not include javascript:alert(2)" "${MAIL_THREAD_BODY}" "javascript:alert(2)"
e2e_assert_contains "thread does not include onerror" "${MAIL_THREAD_BODY}" "onerror"
